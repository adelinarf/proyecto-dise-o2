package main.kotlin
class ScatterSearch(private val capacity: Int, private val weights: IntArray, private val profits: IntArray, private val n: Int, private val neighborhood: Int = 0) {
	private val grasp = GraspKnapsack(capacity, weights, profits, n)
	private val ks = LocalSearchKnapsack(capacity, weights, profits, n, neighborhood)
